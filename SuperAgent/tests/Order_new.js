...
function main() {
	...
	Console.WriteLine(CheckValue("grScrollView.Controls[8].Controls[0].Controls[0].Text", "Характеристики")+ " Check descriptions \" Характеристики\"");
	
	Console.WriteLine(CheckValue("grScrollView.Controls[10].Controls[0].Controls[0].Text", "Default feature")+ "Default feature");
	
	Console.WriteLine(CheckValue("grScrollView.Controls[12].Controls[0].Controls[0].Text", "синий, металл")+ "Синий металл");
	Console.WriteLine(Device.Click("grScrollView.Controls[12]"));// Choose first feature
	...
	Console.WriteLine(CheckValue("grScrollView.Controls[14].Controls[0].Controls[0].Text", "Красный, шоколад")+ "Красный. шоколад");
	...
	Console.WriteLine(Device.GetValue("grScrollView.Controls[14].Controls[0].Controls[0].Text"));
	...
	Console.WriteLine(CheckValue("grScrollView.Controls[10].Controls[0].Controls[0].Text", "Красный")+ "Красный");	
