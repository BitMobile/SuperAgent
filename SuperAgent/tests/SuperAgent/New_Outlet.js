...
function main() {
	...
	var result = Device.SetText(
			...
			"Тестовая т.т"); // Проверка изменения названия т.т. из
								// мобильного приложения
	Console.WriteLine(result);

	Console.WriteLine(TextCheck(
			"grScrollView.Controls[0].Controls[0].Controls[0]", "Новый адрес")); // Адрес
																					// т.т.
	...
	var result = Device.Click("grScrollView.Controls[8]");// Выбор
															// дистрибьютора
															// т.т.
	...
	/*
	 * var result = Device.Click("btnForward"); Console.WriteLine(result);
