...
function main() {
	...
	// Console.WriteLine(CheckValue("headerDescr.Controls[0].Controls[0].Controls[0].Controls[0].Text",
	// outlet));
	Console
			.WriteLine(Device
					.GetValue("headerDescr.Controls[0].Controls[0].Controls[0].Controls[0].Text"));
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[6].Controls[0].Controls[0].Text", "А"));
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[14].Controls[0].Controls[0].Text", "1254"));

	var result = Device.Click("grScrollView.Controls[20]"); // Выбор параметра
															// строкового
															// типа(Правильная
															// выкладка)
	Console.WriteLine(result
	...
	Console
			.WriteLine(CheckValue(
					"grScrollView.Controls[20].Controls[0].Controls[0].Text",
					"String"));

	var result = Device.Click("grScrollView.Controls[40]"); // Выбор параметра
															// Десятичного типа
															// (Размер
															// дебиторской
															// задолженности)
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[40].Controls[0].Controls[0].Text", "125.4"));
	...
	Console
			.WriteLine(Device
					.GetValue("grScrollView.Controls[24].Controls[0].Controls[0].Text")); // Проверка
																							// отображения
																							// Даты
	Console.WriteLine(CheckValue(
	...
	var result = Device.Click("grScrollView.Controls[18]"); // Проверка
															// отображения ?
	Console.WriteLine(result);
	var result = Device.Click("btnForward");
	Console.WriteLine(result);
	Console
			.WriteLine(Device
					.GetValue("grScrollView.Controls[18].Controls[0].Controls[0].Text")); // Проверка
																							// отображения
																							// ?
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[18].Controls[0].Controls[0].Text", "?"));

	var result = Device.Click("grScrollView.Controls[16]"); // Выбор параметра
															// Логического типа
															// (Оформление
															// витрины samsung)
	Console.WriteLine(result
	...
	if (result == "True") {
		...
		Console
				.WriteLine(CheckValue(
						"grScrollView.Controls[16].Controls[0].Controls[0].Text",
						"Да"));
	} else {
		var result = Device.Click("btnForward");
		Console.WriteLine(result);
