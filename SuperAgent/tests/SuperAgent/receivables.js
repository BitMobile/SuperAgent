...
function main() {
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[4].Controls[0].Controls[0].Text", "А"));
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[18].Controls[0].Controls[0].Text", "String"
					+ n));
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[2].Controls[0].Controls[0].Text", "String"
					+ n));

	var result = Device.Click("grScrollView.Controls[10]"); // Question (Int)
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[10].Controls[0].Controls[0].Text", "123546"
					+ n));

	var result = Device.Click("grScrollView.Controls[0]"); // Question
															// (Boolean)
	...
	var result = Device.Click("grScrollView.Controls[8]"); // Question
															// (Decimal)
	Console.WriteLine(result + "Question (Decimal)");

	Console.WriteLine(TextCheck("grScrollView.Controls[2].Controls[0]", "123.6"
			+ n));
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[8].Controls[0].Controls[0].Text", "123.6"
					+ n));
	...
	var result = Device
			.Click("grScrollView.Controls[0].Controls[0].Controls[0]"); // SKU
																		// answer
																		// 1
	Console.WriteLine(result + "SKU answer 1");

	Console.WriteLine(TextCheck(
			"grScrollView.Controls[2].Controls[0].Controls[0]", "5" + n));

	Console.WriteLine(TextCheck(
			"grScrollView.Controls[4].Controls[0].Controls[0]", "14" + n));

	Console.WriteLine(TextCheck(
			"grScrollView.Controls[6].Controls[0].Controls[0]", "15" + n));

	Console.WriteLine(TextCheck(
			"grScrollView.Controls[8].Controls[0].Controls[0]", "12" + n));

	var result = Device
			.Click("grScrollView.Controls[10].Controls[0].Controls[0]"); // SKU
																			// answer
																			// 5
	...
	Console.WriteLine(Device
			.GetValue("grScrollView.Controls[4].Controls[0].Controls[0].Text"));
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[4].Controls[0].Controls[0].Text", "54"));
