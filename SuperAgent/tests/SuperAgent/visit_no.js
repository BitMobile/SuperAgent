...
function main() {
	...
	Console.WriteLine(CheckValue(
			...
			"Сумма инкассации: 407"));

	Console.WriteLine(CheckValue(
			"grScrollView.Controls[0].Controls[0].Controls[0].Text", "709")); // Проверка
																				// не
																				// изменились
																				// ли
																				// значения
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[4].Controls[0].Controls[0].Text", "55,00"));
	...
	Console.WriteLine(CheckValue(
			"grScrollView.Controls[0].Controls[1].Controls[0].Text", "431"));
