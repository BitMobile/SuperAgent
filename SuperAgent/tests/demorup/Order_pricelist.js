...
Console.WriteLine(Device.GetValue("grScrollView.Controls[0].Controls[0].Controls[0].Text"));
	var result=CheckValue("grScrollView.Controls[0].Controls[0].Controls[0].Text", "магазин калош");	
	if (result=="False") {
	result="True";
	}
	else {
	...
	Device.TakeScreenshot("NewOrder_without_pricelist");
	...
	if (result == "Error: Index has to be between upper and lower bound of the array.") {
	result="True";
	}
	else { 
	result="False";
