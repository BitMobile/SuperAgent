...
function main() {
	...
	while (true){
		...
		Console.WriteLine(TextCheck("edtSearch", "болер"));
		...
		var result = Device.SetText("headerDescr.Controls[0].Controls[0].Controls[0].Controls[0]", "Наименование не вводится");  //Проверка изменения названия т.т. из мобильного приложения
