...
function main() {
	...
	Console.WriteLine(CheckValue("grScrollView.Controls[10].Controls[0].Controls[0].Text", "123546"+n));
	
	var result=Device.Click("grScrollView.Controls[0]"); // Question (Boolean)
	...
	if (result=="True") {
		...
		var result = Device.Click("btnForward");
		Console.WriteLine(result);	
		Console.WriteLine(CheckValue("grScrollView.Controls[0].Controls[0].Controls[0].Text", "Нет"));
	}
	
	var result=Device.Click("grScrollView.Controls[8]"); // Question (Decimal)
	Console.WriteLine(result+"Question (Decimal)");
	
	Console.WriteLine(TextCheck("grScrollView.Controls[2].Controls[0]", "123.6"+n));	
	
	var result = Device.Click("btnForward");
	Console.WriteLine(result);	
	
	Console.WriteLine(CheckValue("grScrollView.Controls[8].Controls[0].Controls[0].Text", "123.6"+n));
	...
	Console.WriteLine(CheckValue("grScrollView.Controls[4].Controls[0].Controls[0].Text", "?"));
	...
	Console.WriteLine(Device.GetValue("grScrollView.Controls[4].Controls[0].Controls[0].Text"));
	Console.WriteLine(CheckValue("grScrollView.Controls[4].Controls[0].Controls[0].Text", "54"));
